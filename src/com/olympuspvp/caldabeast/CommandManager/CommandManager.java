...
public class CommandManager {
	public static void onCommand(CommandSender s, String cl, String[] args, olySquad os){
			...
			if(s instanceof Player){
				...
				if(args.length == 0){
					...
					//SQUAD ACCEPT
						...
						String squad = olySquad.getSquad(p.getName());
						if(squad == null){
							...
							for(String str : members){
								Player oMember = Bukkit.getPlayer(str);
								if(oMember != null){
	...
	private static void incorrectUsage(CommandSender p){
